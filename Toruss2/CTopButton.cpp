...
void CTopButton::DrawItem(LPDRAWITEMSTRUCT lp)
{
    ...
    const COLORREF clrBG = RGB(34, 34, 34);   // 기본
    ...
    const COLORREF clrTextNorm = RGB(255, 255, 255);// 비선택 텍스트(회색)
    ...
    CRect rcText = rcDraw;
    rcText.DeflateRect(40, 0, 40, lineH);   // 좌우 여백, 아래 underline 피함
...
void CTopButton::OnLButtonDown(UINT nFlags, CPoint point)
{
    ...
    SetTimer(TIMER_PRESS_ANIM, 3, nullptr); // 약 60fps
